...
(function () {
  ...
  function renderDuelMarket(market) {
    ...
    return '<div class="pm-duel">' +
      '<div class="pm-duel-side">' +
        '<span class="pm-duel-label">' + escapeHtml(o[0].outcome) + '</span>' +
        '<span class="pm-duel-value" style="color:' + leftColor + '">' + o[0].probability.toFixed(1) + '%</span>' +
  ...
  function renderOddsGrid(markets) {
    ...
    for (var i = 0; i < sorted.length; i++) {
      ...
      html += '<div class="pm-odds-item' + flashClass + '">' +
        '<span class="pm-odds-label">' + escapeHtml(label) + '</span>' +
  ...
  function renderPolymarket() {
    ...
    for (var h = 0; h < horizonOrder.length; h++) {
      ...
      for (var e = 0; e < events.length; e++) {
        ...
        // Body
        if (isDuel) {
          html += renderDuelMarket(ev.markets[0]);
        } else {
          html += renderOddsGrid(ev.markets);
        }
